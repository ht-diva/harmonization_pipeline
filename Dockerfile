...
LABEL io.github.snakemake.conda_env_hash="04fb36e5dc5d05a1de17d5bdefa4566a29704ac48aaa361ef02161860612df4d"
...
#   prefix: /conda-envs/e07fa613107c374bb69ca7b7bbd7aaed
#   name: gwaspipe
#   channels:
#     - conda-forge
#     - defaults
...
#     - mscorefonts
#     - pip:
#         - git+https://github.com/ht-diva/gwaspipe.git@5f4e004
RUN mkdir -p /conda-envs/e07fa613107c374bb69ca7b7bbd7aaed
COPY workflow/envs/gwaspipe.yaml /conda-envs/e07fa613107c374bb69ca7b7bbd7aaed/environment.yaml
...
RUN mamba env create --prefix /conda-envs/6e056d31662ab0bd2fd3fba49416042f --file /conda-envs/6e056d31662ab0bd2fd3fba49416042f/environment.yaml && \
    ...
    mamba env create --prefix /conda-envs/e07fa613107c374bb69ca7b7bbd7aaed --file /conda-envs/e07fa613107c374bb69ca7b7bbd7aaed/environment.yaml && \
