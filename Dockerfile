...
LABEL io.github.snakemake.conda_env_hash="61e1f7237851e980565ac4b5001961303e0783007cac1b6ab0690bfaa027fb93"
...
#   prefix: /conda-envs/8e671ac06fd58822cdfc447be72440b3
#   name: gwaspipe
#   channels:
#     - conda-forge
#     - defaults
...
#     - mscorefonts
#     - pip:
#         - git+https://github.com/ht-diva/gwaspipe.git@3c6e2e0
RUN mkdir -p /conda-envs/8e671ac06fd58822cdfc447be72440b3
COPY workflow/envs/gwaspipe.yaml /conda-envs/8e671ac06fd58822cdfc447be72440b3/environment.yaml
...
RUN mamba env create --prefix /conda-envs/6e056d31662ab0bd2fd3fba49416042f --file /conda-envs/6e056d31662ab0bd2fd3fba49416042f/environment.yaml && \
    ...
    mamba env create --prefix /conda-envs/8e671ac06fd58822cdfc447be72440b3 --file /conda-envs/8e671ac06fd58822cdfc447be72440b3/environment.yaml && \
