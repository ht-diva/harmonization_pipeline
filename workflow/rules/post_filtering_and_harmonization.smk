...
rule post_filtering:
    ...
    threads: lambda wc, attempt: get_resources("post_filtering", attempt)["threads"]
    resources:
        mem_mb = lambda wc, attempt: get_resources("post_filtering", attempt)["mem_mb"],
        runtime = lambda wc, attempt: get_resources("post_filtering", attempt)["runtime"]
    shell:
